...
_map_s3_source_errors = map_connector_authentication_errors(
    "S3",
    is_s3_authentication_error,
    source=True,
    source_kind="s3",
    is_unavailable_error=is_s3_unavailable_error,
    unavailable_message="Source object storage could not be reached.",
)
