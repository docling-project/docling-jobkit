...
class GoogleDriveCoordinates(BaseModel):
    ...
    token_path: Annotated[
        ...
        Field(
            description=(
                "Path to save the OAuth 2.0 access token, which is generated on the fly. Required."
            ),
            examples=[
    ...
    credentials_path: Annotated[
        ...
        Field(
            default="",
            description=(
                "Path to the OAuth 2.0 Client ID credentials (available in Google Cloud console). Required."
            ),
            examples=[
    ...
    credentials: Annotated[
        ...
        Field(
            default=None,
            description="OAuth 2.0 Client ID' credentials (available in Google Cloud console). Optional, defaults to empty.",
        ),
    ]
